...
*The current President’s Management Agenda (PMA) is due to wrap up at the end of 2021. So what’s next? Today I spoke at the [ACT-IAC Shared Services Summit](https://www.actiac.org/events/shared-services-summit-2020) on the vision for the future PMA. Below is an overview of my remarks.*
...
- We have agreements on government-wide business standards for common mission support so we can better track our success and outcomes; 
- We are increasing use of existing shared services where we have it to save taxpayer money

Agencies need to continue to move forward on adopting shared services. This is a key way to:
- Close the gap between industry and federal performance so we can delivery for taxpayers the way they get service everywhere else
