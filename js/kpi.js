...
var codeBlock14 =  '<h3>Women-Owned Small Business Federal Contracts</h3>' + '<p>How are federal agencies meeting their obligation to contract with more women-owned small businesses? Use this dashboard to examine five years of data on federal awards for women-owned small businesses. Apply the drop downs filters to adjust the visuals and explore breakdowns by agency, state and fiscal year. The data displayed in the dashboard is populated from the Federal Procurement Data System (FPDS).</p>'  +
